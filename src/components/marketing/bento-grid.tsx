...
const itemsSample: BentoItem[] = [
    ...
    {
        id: "business-tools",
        title: "Dominance Toolkits",
        description: "Custom-engineered operational frameworks and proprietary toolstacks that eliminate friction. We install the performance engines that power your scaling.",
        icon: <Rocket className="w-5 h-5 text-zeniac-gold" />,
        status: "New",
        tags: ["Toolstacks", "Efficiency", "Scale"],
        colSpan: 1,
        hasPersistentHover: true,
        cta: "Claim Tech Inventory",
    },
];
